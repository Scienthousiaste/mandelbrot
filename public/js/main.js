...
import { arbAdd, testArbNumber, arbNumber, toNumber } from "./abitrary_precision.js";
...
/*
TODOS
- might be useful: large multiplication http://www.numberworld.org/y-cruncher/internals/multiplication.html
- find a way to use arbitrary precision, or at least double precision https://github.com/alexozer/glsl-arb-prec
- try the decimal library in JS https://github.com/MikeMcl/decimal.js/
- Arbitrary-precision arithmetic : https://en.wikipedia.org/wiki/Arbitrary-precision_arithmetic
- unzoom, continuous translations, show FPS
- make it beautiful
- is there a way to change maxIterations dynamically? Simple to try: have a huge fixed limit,
 and an if on a dynamic limit inside the loop
*/

document.addEventListener("DOMContentLoaded", async () => {
    let aa = arbNumber(13.123);
    let bb = arbNumber(21418000.001);
    console.log(arbAdd(aa, bb));
    debugger
    testArbNumber()
